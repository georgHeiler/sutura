...
fn a_predicate_binding_a_parameter_the_set_does_not_hold_is_refused() {
    ...
    assert_eq!(
        ...
        IncoherentBindings::ParamOutOfRange { index: 5, params: 1 },
...
fn a_predicate_binding_out_of_placeholder_order_is_refused() {
    ...
    assert_eq!(
        ...
        IncoherentBindings::ParamOutOfOrder { position: 0, index: 1 },
...
fn a_parameter_no_predicate_binds_is_refused() {
    assert_eq!(
        ...
        IncoherentBindings::ParamNeverRead { read: 1, params: 2 },
...
fn the_empty_set_is_the_same_whichever_way_it_is_built() {
    ...
    assert_eq!(PlanBindings::none().filters(), []);
    assert_eq!(PlanBindings::none().params(), []);
}
